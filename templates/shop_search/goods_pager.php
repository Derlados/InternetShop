<div class="goods_pager">
    <a <?php echo $backPageHref?>>
        <img class="pager_arrow" src="/Images/Site/pager_arrow_back.png" alt="pager_arrow_back.png">
    </a>
    ...
    <a <?php echo $nextPageHref?>>
        <img class="pager_arrow" src="/Images/Site/pager_arrow_next.png" alt="pager_arrow_next.png">
    </a>
</div>